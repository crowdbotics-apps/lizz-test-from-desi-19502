...
export class _Blank extends React.Component {
  ...
  render = () => (
    ...
    >
      ...
      >
        Text - The quick brown fox - montserrat
      </Text>
      <Input
        placeholder="Text input - The quick brown fox - open sans"
        editable={true}
      ...
      />
      <Input
        placeholder="Number Input - The quick brown fox - lato"
        editable={true}
      ...
      />
      <Input
        placeholder="Textarea - The quick brown fox - crimson"
        editable={true}
        multiline={true}
        textStyle={{
          height: 100,
